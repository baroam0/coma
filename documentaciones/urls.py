...
urlpatterns = [
    path('lista/', views.listar_documentaciones, name='listar_documentaciones'),
    path('buscar', views.buscar_documentaciones, name='buscar_documentaciones'),
    path('crear/', views.crear_documentacion, name='crear_documentacion'),
    path('editar/<int:pk>', views.editar_documentacion, name='editar_documentacion'),
